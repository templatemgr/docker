...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202407071610-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  09-registry.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Jul 07, 2024 16:10 EDT
# @@File             :  09-registry.sh
# @@Description      :
...
[ -f "$CONF_DIR/env/docker-registry.script.sh" ] && . "$CONF_DIR/env/docker-registry.script.sh" # Generated by my dockermgr script
[ -f "$CONF_DIR/env/docker-registry.sh" ] && . "$CONF_DIR/env/docker-registry.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
APPLICATION_FILES="$LOG_DIR/docker-registry.log"
